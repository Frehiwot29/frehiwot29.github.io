...
const students = [
    ...
    { name: "Kalab", grade: 94, course: ["CS301", "CS303"] },
    { name: "Eyual", grade: 95, course: ["CS301", "CS303"] },
    { name: "Banaher", grade: 92, course: ["CS301", "CS303"] },
    { name: "Haben", grade: 91, course: ["CS301", "CS303"] }
]
...
let averag = students.filter(s => s.course.includes("CS303"));
