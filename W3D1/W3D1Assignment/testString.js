...
*/
describe("countProperty", function () {

    it("2 properties", function () {
        const bob = { name: "Bob", age: 10 };
        assert.strictEqual(str.countProperty(bob), 2);
    });
});
/*
...
*/
describe("commonSuffex", function () {
    const jackson = "Jackson";
    const johnson = "Johnson";
    const wholesome = "wholesome";

    it("checks for true case", function () {
        assert.strictEqual(str.commonSuffex(jackson, johnson), "son");
    });
    it("checks for false case", function () {
        assert.strictEqual(str.commonSuffex(jackson, wholesome), "");
    });
});
